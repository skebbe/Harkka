...
<c:url var="addAction" value="/application/add" ></c:url>

<form:form action="${addAction}" commandName="application">
<table>
	<c:if test="${!empty application.name}">
	<tr>
		<td>
			<form:label path="id">
...
<c:if test="${!empty listApplications}">
	<table class="tg">
	<tr>
		<th width="80">application ID</th>
		<th width="120">application fname</th>
		<th width="120">application lname</th>
		<th width="60">Edit</th>
	...
	<c:forEach items="${listPersons}" var="person">
		<tr>
			...
			<td><a href="<c:url value='/remove/${application.id}' />" >Delete</a></td>
		</tr>
	</c:forEach>
	</table>
</c:if>
